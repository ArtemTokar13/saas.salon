...
INSTALLED_APPS = [
    ...
    'billing',
    'api',
    'whatsapp_bot',  # WhatsApp AI integration
    # Allauth
...
MIDDLEWARE = [
    ...
    'django.middleware.common.CommonMiddleware',   # ← має бути тут
    'django.middleware.locale.LocaleMiddleware',   # ← після CommonMiddleware
...
ACCOUNT_EMAIL_VERIFICATION = 'optional'  # or 'mandatory' if you want to require email verification
...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        ...
        # APP credentials are configured in the database via SocialApp model
        # Do not define 'APP' here to avoid conflicts
    }
}
