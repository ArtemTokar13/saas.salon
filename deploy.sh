...
SSH_KEY="${SSH_KEY:-C:/Users/Artem/OneDrive/Documentos/touch_all.pem}"
REMOTE_DIR="${REMOTE_DIR:-/home/ubuntu/reserva-ya-saas}"
LOCAL_DIR="${LOCAL_DIR:-$(pwd)}"

# Rsync excludes (adjust as needed)
EXCLUDES=(--exclude ".git" --exclude "venv" --exclude ".venv" --exclude "__pycache__" --exclude "uploads" --exclude "db.sqlite3" --exclude ".env")
